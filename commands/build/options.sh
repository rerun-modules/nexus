...
# Created: Sat Nov 10 13:51:20 PST 2012
#
#/ usage: nexus:build  --url|-u <http://www.sonatype.org/downloads/nexus-2.0.6-bundle.zip>  --format|-f <rpm>  --release|-r <1>  --version|-v <>  --directory|-d <> 
...
rerun_options_parse() {
    ...
    [ -z "$URL" ] && URL="http://www.sonatype.org/downloads"
    [ -z "$FORMAT" ] && FORMAT="rpm"
    [ -z "$RELEASE" ] && RELEASE="1"
